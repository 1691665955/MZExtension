...
- (void)drawRect:(CGRect)rect {
    if (self.maxTextLength > 0) {
        ...
        CGRect rect1 = [[NSString stringWithFormat:@"%ld/%ld",(long)self.text.length,(long)self.maxTextLength] boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:self.font,NSForegroundColorAttributeName:self.placeholderColor} context:nil];
        ...
        [[NSString stringWithFormat:@"%ld/%ld",(long)self.text.length,(long)self.maxTextLength] drawInRect:frame withAttributes:@{NSFontAttributeName:self.font,NSForegroundColorAttributeName:self.placeholderColor}];
    }
